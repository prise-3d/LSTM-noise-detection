...
def create_model(input_shape):
    ...
    model.add(GRU(input_shape=input_shape, units=512, activation='sigmoid', recurrent_activation='hard_sigmoid', dropout=0.5, recurrent_dropout=0.5, return_sequences=True))
    model.add(GRU(units=256, activation='sigmoid', dropout=0.5, recurrent_dropout=0.5, recurrent_activation='hard_sigmoid'))
