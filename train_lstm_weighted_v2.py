...
def create_model(input_shape):
    ...
    model.add(LSTM(input_shape=input_shape, units=1024, activation='sigmoid', recurrent_activation='hard_sigmoid', dropout=0.3, return_sequences=True))
    ...
    model.add(LSTM(input_shape=input_shape, units=256, activation='sigmoid', recurrent_activation='hard_sigmoid', dropout=0.3, return_sequences=True))
    model.add(LSTM(input_shape=input_shape, units=128, activation='sigmoid', recurrent_activation='hard_sigmoid', dropout=0.3, return_sequences=True))
